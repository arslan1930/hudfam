...
if (!file_exists(__DIR__ . '/config.php')) {
    ...
    try {
        ...
        require_once __DIR__ . '/includes/country_catalog.php';
        ensure_country_catalog_schema();
        $migrated = migrate_sites_into_country_catalog();
        $notes[] = 'country_catalog_sites OK' . ($migrated ? " (migrated {$migrated} row ops from project sites)" : '');
...
<div class="login-wrap">
  <div class="login-card">
    <h1>Upgrade</h1>
    <p class="muted">Adds global country catalog, email campaign sheets, prospect inventory, multi-admin contacts, and prior upgrades.</p>
