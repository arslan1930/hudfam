...
<form method="post" class="invoice-generate-form" action="index.php?page=admin_invoice_manual" data-draft-form="invoice-manual">
  ...
  <section class="card">
    <h2><?= label_with_info('Invoice details', 'Number is auto-assigned and unique. Add a short note later under the invoice number on All invoices.') ?></h2>
    <div class="form-grid">
      <div>
        ...
        <p class="help" style="margin:0.35rem 0 0">Next number — locked &amp; unique. Notes are added on All invoices.</p>
      </div>
      <div>
