<?php
/**
 * ASCII labels from the IANA Root Zone Database (plus xk for Kosovo).
 * Used by Clean / Filter unique sites so real geoTLDs like .gal and .madrid
 * are not skipped. Fakes such as .comz stay out.
 *
 * @return list<string>
 */
function iana_ascii_tld_labels(): array
{
    static $list = null;
    if ($list !== null) {
        return $list;
