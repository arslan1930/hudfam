...
function guide_orders(): string
{
    return render_page_purpose(
        ...
        [
            'Processing default view is All Processing. Use the chips for Website prices Processing, Leftover, or Added here (+ Add order). Fill LIVE URL, country, and client email or name, then Mark completed — saving a live URL does not complete the row. Save still works on half-filled Processing rows.',
