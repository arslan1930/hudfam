...
function render_admin_panel_guide(): string
{
    return '<section class="panel-guide">'
        ...
        . '<article class="panel-guide-card">'
        . '<h3>3. Emails DATA</h3>'
        . '<p><strong>What:</strong> Sites with emails - Admin (final site + email archive from Team).</p>'
        . '<p><strong>How:</strong> Filled when Team pushes from Sites with emails - Team after adding emails.</p>'
        . '</article>'
        . '<article class="panel-guide-card">'
        . '<h3>4. Add history</h3>'
        ...
        . '<li>Team adds emails, then <strong>Push to Admin</strong> → <strong>Emails DATA → Sites with emails - Admin</strong>.</li>'
        . '</ol>'
        . '</div>'
        . '</section>';
}
