...
function guide_emails_data(): string
{
    return render_page_purpose(
        ...
        'Three separate stores. Admin is the working list Team Push fills. Final keeps a copy after emailed or remove on Admin. Campaign is project country sheets for Communication Team.',
        ...
        [
            ...
            'Final: archive copy of Admin; emailed or remove on Admin keeps a copy here. Repair copies Admin → Final. Adding a site here also creates the Admin working-list row. Existing folders open from the list; use Open an empty country only for a country that is not listed yet. Paste or import CSV / Excel / TXT like Campaign.',
