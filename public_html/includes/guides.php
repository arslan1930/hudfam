...
function guide_emails_data(): string
{
    return render_page_purpose(
        ...
        [
            ...
            'Final: archive copy of Admin; emailed/remove keeps a copy here. Repair copies Admin → Final. Adding a site here also creates the Admin working-list row. Paste or import CSV / Excel / TXT like Campaign.',
...
function guide_orders(): string
{
    return render_page_purpose(
        ...
        [
            ...
            'Completed: unpaid until Paid. Tick Bill boxes and Push to invoice, or use Push unpaid (N) to open Generate with this filter’s unpaid rows ticked (or an honest label if the list is too long). Paid stays in this folder. Website prices status is not changed when you mark paid.',
