...
/**
 * Replace the domain list for one Site adding history day (Admin edit).
 * History-only by default; optionally remove dropped domains from Our database.
 *
 * @return array{ok:bool,error?:string,total?:int,inserted?:int,removed?:int,db_removed?:int,domains?:list<string>,invalid?:int}
 */
