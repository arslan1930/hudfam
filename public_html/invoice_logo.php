 ...
 *
 * Filenames are unguessable (random hex). No login gate — <img> tags and print
 * preview must load even when the session cookie is not sent with the image request.
 */
