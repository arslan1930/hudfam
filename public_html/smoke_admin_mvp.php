...
if (!str_contains($invoicesLib, 'function append_orders_to_invoice')
    ...
    || !str_contains($invoicesLib, 'keep recent drafts pickable')
    ...
    || !str_contains($invoiceGenerate, 'list_invoices_open_for_append(200)')
    || !str_contains($invoiceGenerate, 'invoice_can_append_orders($candidate)')
